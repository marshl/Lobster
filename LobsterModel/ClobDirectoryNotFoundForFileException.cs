//-----------------------------------------------------------------------
// <copyright file="ClobDirectoryNotFoundForFileException.cs" company="marshl">
...
namespace LobsterModel
{
    ...
    /// <summary>
    /// The exception for when a file is not found in any of the ClobDirectories known to Lobster.
    /// </summary>
    [Serializable]
    internal class ClobDirectoryNotFoundForFileException : Exception
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClobDirectoryNotFoundForFileException"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClobDirectoryNotFoundForFileException"/> class with an error 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClobDirectoryNotFoundForFileException"/> class with the serialied info.
        /// </summary>
