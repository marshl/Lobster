//-----------------------------------------------------------------------
// <copyright file="MultipleCLobDirectoriesForFileException.cs" company="marshl">
...
//      [ _The Lord of the Rings_, III/iIv: "Helm's Deep"]
//
//-----------------------------------------------------------------------
namespace LobsterModel
{
    ...
    /// <summary>
    /// The exception for when there are too many ClobDirectories that contain the same file.
    /// This should never be raised unless multiple clob directories have the same folder.
    /// </summary>
    [Serializable]
    internal class MultipleClobDirectoriesFoundForFileException : Exception
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultipleClobDirectoriesFoundForFileException"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MultipleClobDirectoriesFoundForFileException"/> class with an error 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MultipleClobDirectoriesFoundForFileException"/> class with the serialied info.
        /// </summary>
