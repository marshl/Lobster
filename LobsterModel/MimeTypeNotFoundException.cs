//-----------------------------------------------------------------------
// <copyright file="MimeTypeNotFoundException.cs" company="marshl">
...
namespace LobsterModel
{
    ...
    /// <summary>
    /// The exception for when an error occurs when attempting to match a supplied mime type to the dictionary.
    /// </summary>
    [Serializable]
    public class MimeTypeNotFoundException : Exception
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MimeTypeNotFoundException"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MimeTypeNotFoundException"/> class with an error 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MimeTypeNotFoundException"/> class with the serialied info.
        /// </summary>
